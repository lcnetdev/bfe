bfe.define('src/lookups/bflcTypes', ['require', 'exports', 'src/lookups/lcshared', 'src/bfelogging'], function (require, exports) {
    ...
    exports.scheme = 'http://id.loc.gov/vocabulary/bflcTypes';
  
    exports.source = function (query, processSync, processAsync) {
        // console.log(JSON.stringify(formobject.store));

        var scheme = 'http://id.loc.gov/vocabulary/bflcTypes';
        ...
        if (listitems.length > 0) {
            ...
            setTimeout(
                function () {
                    var url = 'https://id.loc.gov/ontologies/bflc.json';
                    $.ajax({
                        url: url,
                        dataType: 'json',
                        success: function (data) {
                            ...
                            var item = {
                                ...
                                source: "Deprecated",
                                value: "Deprecated", 
                                display: "Deprecated (bflc:Deprecated)"
                            }
                            listitems.push(item);
