...
// >>> >>>> aws
  ...
  function menuSelect(spid) {
    ...
    */
    ...
    // End of getForm function, some 800+ lines later.
    ...
    // End preloadData function, some 200+ lines later.
            ...
            if ( property.propertyURI == "http://id.loc.gov/ontologies/bibframe/contribution" ) {
                ...
                if (
                    ...
                    if (_.isEmpty(scheme_t)) {
                        ...
                        if (!_.isEmpty(source_t)) {
                            var source_code = _.find(bfestore.store, {
                                s: source_t.o,
                                p: "http://id.loc.gov/ontologies/bibframe/code"
                            });
                            if (!_.isEmpty(source_code)) {
                                if (source_code.o == "gmgpc" || source_code.o == "lctgm" ) {
                                    scheme = "http://id.loc.gov/vocabulary/graphicMaterials";
                                } else if (source_code.o == "lcgft" ) {
    ...
    // End loadPropsdata some 200 lines later. 
    ...
    exports.labelMaker = function (pd, property){
        ...
        if (labeldata.length === 0 & pd.otype === 'uri') {
            ...
            if (!_.isEmpty(tpreflabel)) {
                ...
                // Found a main title
                if (!_.isEmpty(titleSortKey)) titleSortKey.o = tmainTitle.o;

                if (!_.isEmpty(parentLabel)) parentLabel.o = tmainTitle.o;
